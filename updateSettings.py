...
class MakeConf():
    ...
    def writeConfig(self):
        ...
        conf_file['DComputers']['groups'] = str(base64.b64encode(bytes('{"Admin":["Office365_ES5", "DC-Admin", "Local-Administrator", "Remote Desktop Users", "SG_FS_Admin", "SG_FS_Course", "SG_FS_Backups", "SG_FS_Images", "Administrators"],"Member HF":["Office365_ES5", "DC-Member", "SG_FS_Backups", "SG_FS_Images"],"Member DCM":["Office365_ES5", "DC-Member", "SG_FS_Backups", "SG_FS_Images"],"Member AH":["Office365_ES5", "DC-Member", "SG_FS_Backups", "SG_Backups", "Backups", "SG_FS_Images"]}','UTF-8')).decode("UTF-8"))
